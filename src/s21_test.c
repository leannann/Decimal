...
START_TEST(s21_div_negative) {
  ...
  s21_decimal value_3 = {{20}, 0};
  s21_decimal value_4 = {{5}, 0};
  set_sign(&value_4);
  test.bits[0] = 4;
  memset(&result, 0, sizeof(s21_decimal));
...
START_TEST(s21_div_min_pow) {
  s21_decimal value_1 = {{3333388888}, 0};
  s21_decimal value_2 = {0};
  s21_decimal result = {0};
  s21_decimal test = {0};
...
START_TEST(s21_div_pow_small) {
  s21_decimal value_1 = {{291}, 0};
  s21_decimal value_2 = {{123}, 0};
  s21_decimal result = {0};
  s21_decimal test = {0};
...
START_TEST(s21_div_one) {
  s21_decimal value_1 = {{745}, 0};
  s21_decimal value_2 = {{1}, 0};
  s21_decimal result = {0};
  s21_div(value_1, value_2, &result);
...
START_TEST(isEqual) {
  s21_decimal a = {{48, 0}, 0}, b = {{48, 0}, 0};
  ck_assert_uint_eq(s21_is_equal(a, b), 1);
}
END_TEST

START_TEST(isEqual1) {
  s21_decimal a = {{1, 1, 0, 0}, 0}, b = {{1, 1, 1, 0}, 0};
...
START_TEST(s21_not_equal_normal) {
  s21_decimal value = {{5}, 0};
  s21_decimal test = {{6}, 0};
  int res = s21_is_not_equal(value, test);
...
START_TEST(s21_one_sign) {
  s21_decimal value_1 = {{150}, 0};
  s21_decimal value_2 = {{50}, 0};
  s21_decimal result = {0};
  s21_decimal test = {{100}, 0};
  set_sign(&value_1);
  s21_add(value_1, value_2, &result);
  ck_assert_uint_eq(result.bits[0], test.bits[0]);
...
START_TEST(s21_truncate_pow) {
  s21_decimal value_1 = {{154345}, 0};
  s21_decimal result = {0};
  s21_decimal test = {{154}, 0};
  set_sign(&value_1);
...
START_TEST(s21_negate_negative) {
  s21_decimal value_1 = {{123455}, 0};
  s21_decimal result = {0};
  s21_decimal test = {{123455}, 0};
  set_sign(&value_1);
  s21_negate(value_1, &result);
  ck_assert_uint_eq(result.bits[0], test.bits[0]);
  ck_assert_int_eq(get_sign(result), 0);
...
START_TEST(s21_float_dec_normal_1) {
  s21_decimal value_2 = {0};
  float a = 1.234;
  float b = 0;
  int res = s21_from_float_to_decimal(a, &value_2);
...
Suite *s21_decimal_suite() {
  ...
  tcase_add_test(tc_float_dec, s21_float_dec_normal_1);
